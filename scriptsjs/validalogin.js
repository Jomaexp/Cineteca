/* Esta función va a comparar los valores tomados de los campos de un
    formulario usuario y password con expresiones regulares para validar que 
...
function validarPassword() {
    ...
    /* Si la variable password está vacía se asignará a msgError el mensaje
    pertinente y se asignará false a la variable ok */
    if (password.length == 0) {
        ok = false;
        msgError = "Rellene el campo de contraseña";
    ...
    } else if (v_password.test(password)) {
        ok = true;
    } else {
